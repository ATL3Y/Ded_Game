...
namespace FluffyUnderware.Curvy
{
    ...
    public class CurvySplineSegment : MonoBehaviour, IComparable, IPoolable
    {
        ...
        [SerializeField, FormerlySerializedAs("UserValues")]
        Vector3[] m_UserValues = new Vector3[0];
        #endregion
        ...
        */
        ...
        {
                System.Array.Resize<Vector3>(ref m_UserValues, size);
        }
        ...
        Vector3 parallelTransportFrame(ref Vector3 lastUp, ref Vector3 T1, ref Vector3 T2)
        {
            Vector3 A = Vector3.Cross(T1, T2);
            float a = Mathf.Atan2(A.magnitude, Vector3.Dot(T1, T2));
            return Quaternion.AngleAxis(Mathf.Rad2Deg * a, A.normalized) * lastUp;
        }
        ...
        [System.Obsolete("Use transform - it's cached by Unity now!")]
        ...
        [System.Obsolete("Use Connection instead!")]
